 ...
 * @author EREN
 */
public class arithmeticMean extends JFrame{
    JTextArea textArea;
    JLabel label;
    ArrayList<Double> numberList = new ArrayList<>();
    double sum = 0;
    public arithmeticMean(){
        setTitle("Aritmetik Ortalama Hesaplayıcı");
        setSize(360,400);
        ...
        JButton hesaplaButton = new JButton("Aritmetik Ortalama Hesapla");
       
        hesaplaButton.addActionListener((ActionEvent e) -> {
            dispose();
            String[] numbers = cleanTextArea(textArea);
            double average1 = calcArithmetic(numbers);
            JOptionPane.showMessageDialog(null, "Aritmetik Ortalama: " + average1);
       });
    ...
    public double calcArithmetic(String[] numbers){
